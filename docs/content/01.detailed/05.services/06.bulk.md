...
| [ResourceInvalid](../02.foundation/exc.md#resourceinvalid)                 | ｍ AP Core API のレスポンスが [MapError](../03.entities/06.map-error.md) の場合 |
| [UnexpectedResponseError](../02.foundation/exc.md#unexpectedresponseerror) | ｍ AP Core API のサーバーエラー等の予期せぬエラーが発生した場合                 |
...
6. ｍ AP Core API のサーバーエラー等が発生した場合 [`UnexpectedResponseError`](../02.foundation/exc.md#unexpectedresponseerror) を送出する。
